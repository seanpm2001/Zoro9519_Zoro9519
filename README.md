...
<p><img align="right" width="50%" src="javascript.gif" alt="krismark" /></p>

<p>As a Javascript / PHP developer with 7+ years of professional background, I have successfully developed and published several web and mobile applications using modern JavaScript Frameworks and Libraries such as React(Primary), Vue.js, Next.js, Angular, React Native for the front end and Node.js/Express.js(Primary), Python/Django, PHP/Laravel for the back end.</p>
